...
* **Technical Notes (Hands-On):** Used the ping command to verify reachability between hosts.
* **Theoretical Notes:**
...
* **Technical Notes (Hands-On):** Practical application in ubuntu terminal.
* **Theoretical Notes:**
